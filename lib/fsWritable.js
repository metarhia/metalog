...
class FsWritable extends events.EventEmitter {
  constructor(options) {
    super();
    ...
    this.createStream = options.createStream || fs.createWriteStream;
    this.writeInterval = options.writeInterval || DEFAULT_WRITE_INTERVAL;
    this.writeBuffer = options.writeBuffer || DEFAULT_BUFFER_SIZE;
